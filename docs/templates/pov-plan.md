...
## PoV scope (must include)
- One end-to-end workflow slice
- Representative data (real or realistic)
- At least one integration spike (if required)
- Minimum audit/logging behavior required for security stakeholders (if applicable)
