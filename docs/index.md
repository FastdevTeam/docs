...
5. If you want to **see what good looks like before filling something in**, open the [Examples]({{ "/examples/" | relative_url }}) section and follow one fictional deal end-to-end.
6. If you need to **move from discovery to build**, finish with the [Handover to delivery phase]({{ "/phases/handover/" | relative_url }}) and the [Handover packet template]({{ "/templates/handover-packet/" | relative_url }}).
...
| Validate integrations, environments, access, and NFRs | [Technical deep dive + NFR review]({{ "/phases/technical-deep-dive/" | relative_url }}) | [Technical deep dive template]({{ "/templates/technical-deep-dive/" | relative_url }}) | Solutions Architect |
...
| Turn discovery outputs into delivery-ready backlog and ownership | [Handover to delivery]({{ "/phases/handover/" | relative_url }}) | [Handover packet + backlog format]({{ "/templates/handover-packet/" | relative_url }}) | Product Manager / Delivery Lead |
...
flowchart LR
  ...
  C --> D[Technical deep dive + NFR review]
  D --> E[Security / procurement track]
  C --> F[Prototype / PoV]
  D --> F
  E --> F
  F --> G[Handover to delivery]
...
- **Solutions Architect**: start with [How to run the process]({{ "/process/" | relative_url }}), [Technical deep dive + NFR review]({{ "/phases/technical-deep-dive/" | relative_url }}), and the [Solutions Architect guide]({{ "/audiences/solutions-architect/" | relative_url }}).
- **Product Manager / Delivery Lead**: start with [Workflow workshop]({{ "/phases/workflow-workshop/" | relative_url }}), [Handover to delivery]({{ "/phases/handover/" | relative_url }}), and the [Product Manager / Delivery Lead guide]({{ "/audiences/product-delivery/" | relative_url }}).
...
- [Examples (filled samples)]({{ "/examples/" | relative_url }})
