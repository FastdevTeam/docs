...
2. Collect outcomes, top workflows, constraints
3. Identify systems touched + decision gates
4. Confirm next session dates and attendees

## Inputs to request (evidence)
- 1–3 screenshots or sample artifacts from current workflow
- System list + owners (if known)
- Sample data or example records (even anonymized)
